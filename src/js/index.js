...
*/
//PASSO 1 - precisamos criar uma variável no JS pra trabalhar com a listagem de pokedevs
const listagemSelecaoPokedevs = document.querySelectorAll(".pokedev");

//PASSO 2 - Identificar o evento de clique no elemento da listagem
listagemSelecaoPokedevs.forEach(pokedev =>{
   ...
   desativarCartaoPokedev();
     ...
     //PASSO 6 - adicinar a classe ativo no pokedev selecionado na listagem
     ativarCartaoPokedev(idPokedevSelecionado);
     
    })  
})
function ativarCartaoPokedev(idPokedevSelecionado) {
    pokedevSelecionadoNaListagem = document.getElementById(idPokedevSelecionado);
